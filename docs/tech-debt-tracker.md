...
| TD-004 | Security hardening | Security docs now require DAL authorization, explicit CSRF/Origin checks, super-admin MFA, modern password policy, security headers, and stronger media upload controls; implementation and tests remain production-readiness work. | P003, P004, P007, P012 |
